...
@implementation OAIInstoreCustomerPaymentsAgreementsPaymentTokenData
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"customerRef", @"orderNumber", @"_description", @"billingAddress", @"paymentAgreement"];
