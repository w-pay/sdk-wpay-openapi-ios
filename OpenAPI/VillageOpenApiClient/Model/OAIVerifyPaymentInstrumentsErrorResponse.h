...
@class OAIVerifyPaymentInstrumentsErrorResponseVerifyResponses;



@protocol OAIVerifyPaymentInstrumentsErrorResponse
@end

@interface OAIVerifyPaymentInstrumentsErrorResponse : OAIObject
...
@property(nonatomic) NSArray<OAIVerifyPaymentInstrumentsErrorResponseVerifyResponses>* verifyResponses;
