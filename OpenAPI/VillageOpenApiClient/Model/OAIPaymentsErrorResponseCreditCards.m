...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"stepUp", @"receiptData", @"extendedTransactionData", @"externalServiceCode", @"externalServiceMessage"];
