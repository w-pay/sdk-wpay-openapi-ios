...
@interface OAIGiftcardsBalanceResponseGiftCardBalances : OAIObject

/* The gift card number. This property will only be returned if the endpoint was called with the \"cardNumber\" and \"pinCode\" request properties. [optional]
 */
@property(nonatomic) NSString* cardNumber;
/* The gift card payment instrument id. This property will only be returned if the endpoint was called with the \"paymentInstrumentId\" request property. [optional]
 */
