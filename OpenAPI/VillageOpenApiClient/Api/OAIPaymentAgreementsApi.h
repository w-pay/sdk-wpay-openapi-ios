...
@interface OAIPaymentAgreementsApi: NSObject <OAIApi>

extern NSString* kOAIPaymentAgreementsApiErrorDomain;
extern NSInteger kOAIPaymentAgreementsApiMissingParamErrorCode;
...
///
/// @return OAIPaymentAgreementResponse*
